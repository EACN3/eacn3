...
class TestBalanceEdgeCases:
    ...
    async def test_multiple_deposits_accumulate_exactly(self, mcp, funded_network):
        ...
        r1 = await mcp.call_tool_parsed("eacn_deposit", {
        ...
        r2 = await mcp.call_tool_parsed("eacn_deposit", {
...
class TestFreezeAccounting:
    ...
    async def test_multiple_tasks_freeze_exactly(self, mcp, funded_network):
        ...
        result = await mcp.call_tool_parsed("eacn_get_balance", {"agent_id": "mf-init"})
...
class TestSettlementAccounting:
    ...
    async def test_settlement_exact_amounts(self, mcp, funded_network):
        ...
        payer_mid = await mcp.call_tool_parsed("eacn_get_balance", {"agent_id": "sett-payer"})
        ...
        earner_bal = await mcp.call_tool_parsed("eacn_get_balance", {"agent_id": "sett-earner"})
        assert earner_bal["available"] == 150.0  # Earner gets bid_price
        assert earner_bal["frozen"] == 0.0

        payer_bal = await mcp.call_tool_parsed("eacn_get_balance", {"agent_id": "sett-payer"})
